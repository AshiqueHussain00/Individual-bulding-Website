...
function ExampleComponent() {
  ...
  return (
    <div
      ref={ref}
      className="relative w-[95%] mx-auto bg-transparent ">
      ...
      <motion.div
        ...
        className="flex text-black  w-[38%] gap-5 items-center pr-20 absolute top-[40px] left-[45px] z-[30]"
      ...
      <motion.div
        className="flex gap-5 w-[38%] text-white items-center pr-20  absolute top-[40px] right-[45px] z-[30]"
